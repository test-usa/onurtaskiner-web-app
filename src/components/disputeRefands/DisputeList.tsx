...
export default function DisputeList() {
  const disputes = [
    { id: 12345, user: "Alicia Keys", venue: "Madison Square Garden", disputeNumber: 1 },
    { id: 12346, user: "John Mayer", venue: "Wembley Stadium", disputeNumber: 2 },
    { id: 12347, user: "Taylor Swift", venue: "Allegiant Stadium", disputeNumber: 3 },
    { id: 12348, user: "Drake", venue: "O2 Arena", disputeNumber: 4 },
    { id: 12349, user: "Adele", venue: "Staples Center", disputeNumber: 5 },
    { id: 12350, user: "Bruno Mars", venue: "Sydney Opera House", disputeNumber: 6 },
  ]
  ...
  return (
    <div className="min-h-screen pt-4  md:pt-10 ">
      <h1 className="mb-6 text-xl font-semibold text-[#1B1E28]">Dispute List</h1>
