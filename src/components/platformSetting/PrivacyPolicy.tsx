...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="pt-10">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-[#1F4B78] ">2. Information We Collect:</h2>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-[#1F4B78]">3. How We Use Your Information:</h2>
        <p className="text-sm mb-2">Your information is used for the following purposes:</p>
        <ul className="text-sm space-y-1">
          <li className="flex items-start">
            <span className="text-gray-600 mr-2">✓</span>
            <span>To facilitate event bookings and venue management.</span>
          </li>
          <li className="flex items-start">
            <span className="text-gray-600 mr-2">✓</span>
            <span>To provide personalized event recommendations.</span>
          </li>
          <li className="flex items-start">
            <span className="text-gray-600 mr-2">✓</span>
            <span>To process payments and manage transactions securely.</span>
          </li>
          <li className="flex items-start">
            <span className="text-gray-600 mr-2">✓</span>
            <span>To improve app functionality and security.</span>
          </li>
          <li className="flex items-start">
            <span className="text-gray-600 mr-2">✓</span>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-[#1F4B78]">4. Sharing Your Information:</h2>
        <p className="text-sm mb-2">We do not sell your personal data. However, we may share information with:</p>
        <ul className="text-sm space-y-1">
          <li className="flex items-start">
          ...
          <li className="flex items-start">
            <span className="text-blue-600 mr-2">♦</span>
            <span>Payment Processors – To securely handle transactions.</span>
          </li>
          <li className="flex items-start">
            <span className="text-blue-600 mr-2">♦</span>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-[#1F4B78]">6. Your Rights and Choices:</h2>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-[#1F4B78]">7. Cookies and Tracking Technologies:</h2>
        <p className="text-sm">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-[#1F4B78]">8. Changes to This Privacy Policy:</h2>
        <p className="text-sm">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-[#1F4B78]">9. Contact Us:</h2>
        <p className="text-sm mb-2">If you have questions about this Privacy Policy, please contact us at:</p>
        <ul className="text-sm space-y-1">
