          ...
          <div className="flex flex-col sm:flex-row gap-x-5 space-y-4 sm:space-y-0 mt-4">
            ...
            <div className="w-full flex flex-col gap-y-8">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <p>
                    Lorem ipsum dolor sit amet consectetur. Interdum ac hac nec
                    etiam. Augue etiam ornare eu velit ultrices pharetra. Velit
                    fringilla tellus justo sed et praesent quam praesent in.
                    Scelerisque venenatis leo nunc convallis vel amet faucibus
                    mattis parturient.
                  </p>
                </div>
              </div>
