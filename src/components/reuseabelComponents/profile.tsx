  ...
  return (
    ...
    >
      <Wrapper>
        ...
        <div className="space-y-[8px] pt-36 transform -translate-x-1/2 md:translate-x-0  gap-[24px] sm:gap-[36px]">
          <Avatar className="w-28 h-28 border-2 border-white">
            <AvatarImage src={profil.src} alt="profile-photo" />
            <AvatarFallback>Alex</AvatarFallback>
          </Avatar>
          <div className="flex flex-col md:flex-row gap-[14px] sm:gap-[30px]">
            <div>
              <div className="flex items-center gap-[6px]">
                {/* NAME */}
                <h1 className="text-[15px] sm:text-[20px] leading-[14px] sm:leading-[24px] font-semibold text-[var(--color-accent)]">
                  Alex Jones
                </h1>
                {/* Verify badge */}
                <svg
              ...
              <div className="space-y-[8px]">
                {/* username */}
                <p className="text-[12px] sm:text-[15px] leading-[20px] font-normal">
                  @alex.jones
                </p>
                {/* passion */}
